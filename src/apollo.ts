...
const wsLink = new GraphQLWsLink(createClient({
  ...
  url: process.env.NODE_ENV === 'production'? 'ws://uber-eats-backend.herokuapp.com':'ws://localhost:4000/graphql',
  connectionParams: {
    'x-jwt': authToken() || "", 
  },
}));
...
const httpLink = createHttpLink({
  uri: process.env.NODE_ENV === 'production'? 'ws://uber-eats-backend.herokuapp.com':'ws://localhost:4000/graphql',
});
